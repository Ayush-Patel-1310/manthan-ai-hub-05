  ...
  const features = [
    {
      ...
      description:
        "Leverage cutting-edge AI technologies to solve real-world problems and create revolutionary solutions.",
    },
    {
      icon: Code,
      title: "24-Hour Challenge",
      description:
        "Intense coding marathon where teams race against time to build, test, and present their AI projects.",
    },
    {
      icon: Users,
      title: "Collaborative Environment",
      description:
        "Work with like-minded developers, designers, and AI enthusiasts to bring your ideas to life.",
    },
    {
      icon: Lightbulb,
      title: "Learning & Growth",
      description:
        "Expand your AI knowledge through workshops, mentorship, and hands-on experience.",
    },
    {
      icon: Rocket,
      title: "Industry Recognition",
      description:
        "Showcase your project to industry leaders and potentially launch your AI startup.",
    },
    {
      icon: Zap,
      title: "Fast-Paced Action",
      description:
        "Experience the thrill of rapid prototyping and iterative development in an AI context.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="font-sans text-lg text-manthan-dark-text max-w-3xl mx-auto">
            Manthan is more than just a hackathon—it's a crucible where
            artificial intelligence meets human creativity. Over 24 intensive
            hours, teams will tackle complex AI challenges, push the boundaries
            of machine learning, and demonstrate how technology can
        ...
        <div className="bg-gradient-to-r from-manthan-violet to-manthan-deep-violet rounded-2xl p-8 text-white text-center animate-fade-in hover:scale-105 transition-transform duration-500">
          ...
          <p className="font-sans text-lg opacity-90 max-w-2xl mx-auto">
            ...
            and finance to entertainment and education. Manthan provides the
            perfect platform to explore AI's potential, experiment with
            cutting-edge tools, and create solutions that could change the
            world.
          </p>
        </div>
      </div>
