        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-6 pt-8">
              ...
              <div className="relative mb-8">
                <p className="font-sans text-2xl lg:text-3xl text-manthan-dark-text mb-4 animate-fade-in font-semibold" style={{animationDelay: '0.2s'}}>
              ...
              <p className="font-sans text-xl text-manthan-dark-text/80 mb-8 animate-fade-in leading-relaxed" style={{animationDelay: '0.4s'}}>
              ...
              <div className="bg-gradient-to-r from-manthan-violet/15 to-manthan-lavender/15 rounded-2xl p-6 mb-10 animate-fade-in border-2 border-manthan-lavender/40 shadow-lg" style={{animationDelay: '0.6s'}}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
              <div className="text-center p-6 bg-white/70 rounded-2xl border-2 border-manthan-lavender/40 animate-fade-in hover:shadow-xl hover:scale-105 transition-all duration-300 group backdrop-blur-sm" style={{animationDelay: '0.8s'}}>
                <Clock className="w-8 h-8 text-manthan-violet mx-auto mb-3 group-hover:rotate-12 transition-transform duration-300" />
                <p className="font-mono font-bold text-xl text-manthan-deep-violet">48 Hours</p>
                <p className="font-sans text-sm text-manthan-dark-text">Non-stop Innovation</p>
              </div>
              <div className="text-center p-6 bg-white/70 rounded-2xl border-2 border-manthan-lavender/40 animate-fade-in hover:shadow-xl hover:scale-105 transition-all duration-300 group backdrop-blur-sm" style={{animationDelay: '1s'}}>
                <Users className="w-8 h-8 text-manthan-violet mx-auto mb-3 group-hover:scale-110 transition-transform duration-300" />
                <p className="font-mono font-bold text-xl text-manthan-deep-violet">2-4 Members</p>
                <p className="font-sans text-sm text-manthan-dark-text">Per Dream Team</p>
              </div>
              <div className="text-center p-6 bg-white/70 rounded-2xl border-2 border-manthan-lavender/40 animate-fade-in hover:shadow-xl hover:scale-105 transition-all duration-300 group backdrop-blur-sm" style={{animationDelay: '1.2s'}}>
                <Trophy className="w-8 h-8 text-manthan-violet mx-auto mb-3 group-hover:bounce transition-transform duration-300" />
                <p className="font-mono font-bold text-xl text-manthan-deep-violet">₹5L+</p>
                <p className="font-sans text-sm text-manthan-dark-text">Total Prizes</p>
              </div>
              <div className="text-center p-6 bg-white/70 rounded-2xl border-2 border-manthan-lavender/40 animate-fade-in hover:shadow-xl hover:scale-105 transition-all duration-300 group backdrop-blur-sm" style={{animationDelay: '1.4s'}}>
                <Calendar className="w-8 h-8 text-manthan-violet mx-auto mb-3 group-hover:rotate-12 transition-transform duration-300" />
                <p className="font-mono font-bold text-xl text-manthan-deep-violet">Dec 15-17</p>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative group">
              ...
              <div className="absolute top-20 right-8 w-3 h-3 bg-manthan-lavender/60 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
              <div className="absolute bottom-16 left-6 w-4 h-4 bg-manthan-deep-violet/50 rounded-full animate-bounce" style={{animationDelay: '2s'}}></div>
              ...
              <div className="absolute inset-0 border-4 border-manthan-violet/30 rounded-full animate-spin" style={{animationDuration: '10s'}}></div>
              <div className="absolute inset-8 border-3 border-manthan-lavender/40 rounded-full animate-spin" style={{animationDuration: '8s', animationDirection: 'reverse'}}></div>
              <div className="absolute inset-16 border-2 border-manthan-deep-violet/20 rounded-full animate-spin" style={{animationDuration: '12s'}}></div>
            </div>
          </div>
        </div>

        {/* Enhanced Bottom Banner */}
        <div className="text-center mt-20 animate-fade-in" style={{animationDelay: '2s'}}>
