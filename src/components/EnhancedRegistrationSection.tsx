...
const EnhancedRegistrationSection = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "selectProblem",
      handleProblemSelection as EventListener
    );
    return () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    // link.click();
    const url =
      "https://docs.google.com/document/d/1MhTedr_LlSgvbujxxBBEeyIUCHxUHvTJ4MYTLCe-OEw/copy";
    ...
    if (result.success) {
      ...
      try {
        await supabase
          ...
          .update({
            available_slots:
              problems.find((p) => p.id === problemStatementId)!
                .available_slots - 1,
          })
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="font-sans text-lg text-manthan-dark-text max-w-3xl mx-auto">
            Complete your registration for Manthan AI Hackathon. Download the
            proposal template, fill it out, and upload it along with your
            details.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-manthan-lavender/30 p-8 shadow-lg">
            <div className="text-center">
              ...
              <p className="font-sans text-manthan-dark-text mb-6 max-w-2xl mx-auto">
                Get the official proposal template to structure your AI solution
                and team information. This template will guide you through all
                the necessary sections for your submission.
              </p>
              <Button
          ...
          <div className="bg-white rounded-2xl border border-manthan-lavender/30 p-8 shadow-lg">
            <div className="text-center mb-8">
              ...
              <p className="font-sans text-manthan-dark-text mb-8 max-w-2xl mx-auto">
                Fill in your details and upload your completed proposal document
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <Label
                    htmlFor="name"
                    className="font-sans font-medium text-manthan-dark-text"
                  >
                    Full Name *
                  </Label>
                  <Input
                    ...
                    <div
                      className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${
                        errors.file
                          ...
                          : "border-manthan-lavender/50 hover:border-manthan-violet bg-manthan-lavender/10"
                      }`}
                    >
                      ...
                      <p className="font-sans text-manthan-dark-text">
                        {uploadedFile ? (
                          ...
                          <>
                            Drop your proposal here or{" "}
                            <span className="text-manthan-violet font-medium">
                              click to browse
                            </span>
                          </>
                        )}
